...
mv empire/death_star/chewbacca.txt rebellion/millenium_falcon 
mv empire/death_star/han_solo.txt rebellion/millenium_falcon 
mv empire/death_star/luke_skywalker.txt rebellion/millenium_falcon 
mv empire/death_star/princess_leia.txt rebellion/millenium_falcon 
